...
- **Deliberately not yet built**: WhatsApp invite-link automation (see BRIEF.md's out-of-scope list), and the RLS-scoped `registry.v_leader_registrants` view / export RPC (the auth rollout above unblocks this — still not built).
