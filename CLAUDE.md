...
- **Deliberately not yet built**: WhatsApp invite-link automation (see BRIEF.md's out-of-scope list), the RLS-scoped `registry.v_leader_registrants` view / export RPC (the auth rollout above unblocks this — still not built), and the registrations reload from Lorraine's spreadsheet (parked pending data-handling decisions — see OPERATIONS.md).
