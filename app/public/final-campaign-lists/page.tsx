...
import FinalCampaignListsClient from './FinalCampaignListsClient';
...
const LINK = PUBLIC_LINKS.find((l) => l.slug === 'final-campaign-lists')!;
...
export default function FinalCampaignListsPage() {
  return <FinalCampaignListsClient />;
}
