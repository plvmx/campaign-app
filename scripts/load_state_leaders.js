...
async function loadStateLeaders() {
  try {
    // Read the CSV file
    const csvPath = path.join(__dirname, '..', 'state_leaders.csv');
    ...
    console.log(`Found ${stateLeaders.length} state-leader combinations`);
    ...
    console.log(`Successfully loaded ${data.length} records into state_leaders table`);
